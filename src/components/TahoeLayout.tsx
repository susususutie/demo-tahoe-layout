      ...
      <main className="tahoe-main" ref={mainRef}>
        ...
        <header className="tahoe-content-header">
          <div className="tahoe-header-left">
            {/* 当侧边栏收起时显示悬浮按钮组 */}
            <div className={`tahoe-floating-controls ${isSidebarCollapsed ? 'visible' : ''}`}>
              {/* 三色按钮 */}
              <div className="tahoe-floating-window-controls">
                <button
                  className="tahoe-floating-btn tahoe-close-btn"
                  onClick={() => setIsSidebarCollapsed(false)}
                  aria-label="展开侧边栏"
                />
                <button
                  className="tahoe-floating-btn tahoe-minimize-btn"
                  onClick={() => setIsSidebarCollapsed(false)}
                  aria-label="展开侧边栏"
                />
                <button
                  className="tahoe-floating-btn tahoe-expand-btn"
                  onClick={() => setIsSidebarCollapsed(false)}
                  aria-label="展开侧边栏"
                />
              </div>
